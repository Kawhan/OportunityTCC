...
class UserProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {'nome': 'Nome <span class="teste">*</span>', 'idade': 'Idade <span class="teste">*</span>',
                  'matricula': 'Matricula <span class="teste">*</span>', 'data_ingresso': 'Data de Ingresso <span class="teste">*</span>', 'data_estimada_saida': 'Data Estimada saida <span class="teste">*</span>', 'periodo': 'Período <span class="teste">*</span>', 'cra': 'CRA <span class="teste">*</span>', 'curso': 'Seu curso <span class="teste">*</span>', 'nota_introducao': 'Nota Introdução de Programação <span class="teste">*</span>', 'nota_POO': 'Nota Programação orientada a objeto', 'nota_linguagem': 'Nota Linguagem de linguagem de programação', 'nota_estrutura': 'Nota de Estrutura Dados', 'disposicao': 'Disponibilidade 20 Horas <span class="teste">*</span>', 'numero_disciplinas': 'Número disciplinas Periodo <span class="teste">*</span>', 'link_git_hub': 'Link do GITHUB', 'link_linkedin': 'Link do Linkedin'}
        widgets = {
